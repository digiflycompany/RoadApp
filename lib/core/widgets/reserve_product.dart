...
import '../../features/maintenance_centers/presentation/views/widgets/select_vehicles_drop_down.dart';

class ReserveProduct extends StatelessWidget {
  const ReserveProduct({super.key, this.onTap});
  final void Function()? onTap;

  @override
  Widget build(BuildContext context) {
    bool isArabic = Localizations.localeOf(context).languageCode == 'ar';
    return BlocBuilder<MaintenanceCenterDetailsCubit, MaintenanceCenterDetailsStates>(
        ...
        children: [
          ...
          Column(
            children: [
              ...
              SelectVehiclesDropDown(
                label: StringManager.vehicleType.tr(context),
                hint: StringManager.vehicleType.tr(context),
              ),
