...
class SelectVehiclesDropDown extends StatefulWidget {
  ...
  @override
  SelectVehiclesDropDownState createState() => SelectVehiclesDropDownState();
}

class SelectVehiclesDropDownState extends State<SelectVehiclesDropDown> {
            ...
            child: BlocBuilder<VehiclesCubit, VehiclesState>(
              ...
              return DropdownButton<String>(
                  ...
                  onChanged: (val) {
                    ...
                    debugPrint(
                        "Selected vehiclesId ====>>: ${cubit.vehiclesId}");
                    debugPrint(
