class ExaminationResponse {
  ...
  ExaminationResponse({required this.success, required this.data});

  factory ExaminationResponse.fromJson(Map<String, dynamic> json) {
...
// Add the remaining classes (ChassisAndFrame, EngineAndTransmission, SteeringSystem, ElectricalGroup, AirConditioningSystem, BrakesAndSafety, NotesSection) following the same pattern as above.
