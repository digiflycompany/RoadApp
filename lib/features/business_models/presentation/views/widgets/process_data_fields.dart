...
class ProcessDataFields extends StatefulWidget {
  const ProcessDataFields({super.key});

  @override
  State<ProcessDataFields> createState() => _ProcessDataFieldsState();
}

class _ProcessDataFieldsState extends State<ProcessDataFields> {
  @override
  void initState() {
    super.initState();
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      width: 100.w,
                      height: 40.h,
                      child: cubit.selectedRadio != 2
                          ? NameClientRegularDropDown(
                              hint: StringManager.clientName.tr(context),
                            )
                          : NameClientDropDown(
                              hint: StringManager.supplierName.tr(context),
                            ),
                    ),
                  ],
                ) /*: const SizedBox()*/,
