...
class _FuelDiagramState extends State<FuelDiagram> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: BlocBuilder<FuelConsumingRateCubit, FuelConsumingRateStates>(
            ...
            return Column(
                ...
                children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: DropdownButton<int>(
                            value: cubit.selectedChartFilter,
                            items: const [
                              DropdownMenuItem(
                                  value: 1, child: Text('الشهر الحالي')),
                              DropdownMenuItem(
                                  value: 3, child: Text('آخر 3 أشهر')),
                              DropdownMenuItem(
                                  value: 6, child: Text('آخر 6 أشهر')),
                            ],
                            onChanged: (value) {
                              if (value != null) {
                                cubit.changeSelectedChartFilter(value);
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                    ...
                    Center(
                        child: FuelChart(
                      selectedFilter: cubit.selectedChartFilter,
                    ))
                  ])
                ]);
          },
