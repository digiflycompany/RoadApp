...
class FuelConsumingItem extends StatelessWidget {
  ...
  void _showDeleteConfirmationDialog(
      BuildContext context, FuelConsumingRateCubit cubit) {
    showDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<FuelConsumingRateCubit, FuelConsumingRateStates>(
        listener: (_, state) {
      if (state is DeleteSingleRideErrorState) {
        showToast(message: state.errorMessage, state: ToastStates.error);
      }
    }, builder: (_, state) {
      final FuelConsumingRateCubit cubit = FuelConsumingRateCubit.get(context);
      return Container(
