            ...
            child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Center(
                          child: InkWell(
                            onTap: () => showModalBottomSheet(context: context, builder: (BuildContext context) => const ChangePicBottomSheet()),
                            child: Container(
                                width: 110.w,
                                height: 110.h,
                      ...
                      AccountTextField(text: StringManager.name.tr(context)),
                      AccountTextField(
                          text: StringManager.phoneNumber.tr(context)),
                      AccountTextField(text: StringManager.email.tr(context)),
                      AccountTextField(
