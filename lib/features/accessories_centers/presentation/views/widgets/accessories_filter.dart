...
class AccessoriesFilter extends StatelessWidget {
  const AccessoriesFilter({super.key});
      ...
      IconButton(
          onPressed: () {
            showCustomAlertDialog(
                ...
                content: BlocBuilder<AccessoriesCubit, AccessoriesState>(
                    builder: (context, state) {
                  var cubit = AccessoriesCubit.get(context);
