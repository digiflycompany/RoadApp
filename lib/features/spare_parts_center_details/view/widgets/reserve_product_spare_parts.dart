...
class ReserveProductSpareParts extends StatelessWidget {
  const ReserveProductSpareParts({super.key, this.onTap});
  final void Function()? onTap;

  @override
  Widget build(BuildContext context) {
    bool isArabic = Localizations.localeOf(context).languageCode == 'ar';
    return BlocBuilder<SparePartsCenterDetailsCubit, SparePartsCenterDetailsStates>(
      builder: (context, state) {
        var cubit = context.read<SparePartsCenterDetailsCubit>();
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  SelectVehiclesSparePartsDropDown(
