...
class AppLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> appbarTitles = [StringManager.home.tr(context), StringManager.search.tr(context),  StringManager.messages.tr(context), StringManager.profile.tr(context)];
        ...
        builder: (context, state) {
          ...
          return Scaffold(
              ...
              appBar: PreferredSize(
                ...
                child:
                    CustomAppBar(text: appbarTitles[cubit.currentIndex]),
              ),
