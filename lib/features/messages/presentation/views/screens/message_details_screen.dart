  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: CustomAppBar(text: StringManager.chatDetails.tr(context)),
        ),
        body: Padding(
                  ...
                  child: SingleChildScrollView(
                      child: Padding(
                          ...
                          child: Column(children: [
                            const Message(
                                text:
                                    "لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) و يُستخدم في", received: false,),
                           ...
                           const Message(
                            ...
                            const Message(
                                text:
                                    "لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار للنص الشكلي", received: false),
                            SizedBox(height: 25.h),
                            const Message(
                                text:
                                    "لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن الغاية هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار للنص الشكلي", received: false),
                            ...
                            const Message(
                                text:
                                    "لوريم إيبسوم هو ببساطة نص شكلي (بمعنى أن", received: false)
                          ]))))
            ])),
      bottomNavigationBar: const SendTextField()// Here, Chat GPT!
    );
  }
}