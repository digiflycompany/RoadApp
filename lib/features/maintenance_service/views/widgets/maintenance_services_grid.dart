...
class MaintenanceServicesGrid extends StatelessWidget {
  const MaintenanceServicesGrid(
      {super.key, required this.cubit, this.maintenanceTypeList, required this.scrollController, required this.brandId,});
          ...
          child: BlocBuilder<MaintenanceCubit, MaintenanceState>(
            builder: (context, state) {
              ...
              return GestureDetector(
                onTap: () {
                  cubit.getMaintenanceCenter(brandId: brandId, typeId: maintenanceTypeList[index].id,);
